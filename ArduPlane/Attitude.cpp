...
bool Plane::suppress_throttle(void)
{
    ...
    if (auto_throttle_mode && parachute.release_initiated()) {
        ...
        if(set_pith_max == false){
                 gcs_send_text(MAV_SEVERITY_CRITICAL,"suppress_throttle: set_pith_max: true");
                 set_pith_max = true;
         }
        return true;
    }
    ...
    if (!auto_throttle_mode) {
        ...
        if(set_pith_max == true){
                 set_pith_max = false;
                 gcs_send_text(MAV_SEVERITY_CRITICAL,"suppress_throttle: set_pith_max: false");
        }
        return false;
    }
